...
public class Reflection {
	...
	public static <T> T create(Class<T> clz, Object... args) throws Exception {
		...
		return match(constructors, args).invoke(args);
	}
	...
	public static <O, T> T call(O invokee, String meth, Object... args) throws Exception {
		...
		return match(methods, args).invoke(args);
	}
	...
	private static <T> Jimmy<T> match(Jimmy<T>[] jimmies, Object[] args) {
		loop:
		...
		throw new UtilException("There is no matching jimmy");
	}
